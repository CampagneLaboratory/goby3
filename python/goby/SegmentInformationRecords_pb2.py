...
_BASE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='location', full_name='org.campagnelab.dl.varanalysis.protobuf.Base.location', index=11,
