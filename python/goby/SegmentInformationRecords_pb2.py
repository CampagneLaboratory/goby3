...
_BASE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='position', full_name='org.campagnelab.dl.varanalysis.protobuf.Base.position', index=11,
...
_BASE.fields_by_name['position'].message_type = _REFERENCEPOSITION
