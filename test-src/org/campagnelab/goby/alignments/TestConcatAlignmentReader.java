...
public class TestConcatAlignmentReader {
    ...
    public void testLoadTwoFromHttpURLs() throws IOException {
        ...
        final ConcatAlignmentReader concatReader = new ConcatAlignmentReader(new GobyAlignmentReaderFactory(),
                false, 21, 33031693, 21, 33031798,
                "http://dl.dropbox.com/u/357497/KHTFWNT-419-bis6-chr22-simulated-flat-2.entries",
                "http://dl.dropbox.com/u/357497/MCQPRWA-419-bis6-chr22-simulated-spikes-2.entries");
        count = countAlignmentEntries(concatReader);
    ...
    public void testConcatSamBam() throws IOException {
        ...
        assertEquals(1, concatReader.getNumberOfTargets());
    }
}
