...
public abstract class GenotypeFilter {
     ...
     */
    protected static final Log LOG = LogFactory.getLog(GenotypeFilter.class);
    ...
    public int[] varCountRemovedPerSample;
    public int[] refCountRemovedPerSample;
    public int numFiltered = 0;
    public int numScreened = 0;
    /**
